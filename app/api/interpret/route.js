...
${
  cards.length >= 10
    ? `นี่คือการวางไพ่แบบเซลติกครอส 10 ใบ = ดูภาพรวมชีวิตช่วง 3 เดือนนี้ ต้องอ่านให้ละเอียด "ทีละตำแหน่ง" เลยนะ
...
ห้ามแต่งประโยคชวนปิดท้ายอื่นเพิ่มเอง (เช่น "มีอะไรทักมาเมาท์/อัปเดตได้ตลอด") — ให้บรรทัดสุดท้ายสุดเป็นประโยคนี้ประโยคเดียวเป๊ะๆ ห้ามดัดแปลง: "มีข้อกังวลใจมาลองสุ่มไพ่เล่นได้ตลอดเลยนะ!"`;
  ...
  const requestBody = JSON.stringify({
    ...
    generationConfig: {
      maxOutputTokens: isFollowUp ? 550 : cards.length >= 10 ? 3000 : 1500,
      temperature: 0.85,
